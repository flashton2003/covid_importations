...
per_sample_intros <- read_in_per_sample_intros("/Users/flashton/Dropbox/COVID/AAP_introductions/results/2022.12.02/kenyan_introductions.txt", vocs_to_plot)
...
make_overall_plot(per_sample_intros, "21K (Omicron)", national_cases, restrictions, "KEN")
...
run_main <- function(per_sample_intro_handle, country_iso, n_cases, vocs_to_plot, restrictions){
  ...
  View(n_cases)
  lapply(vocs_to_plot, make_overall_plot, per_sample_intros = per_sample_intros, national_cases = n_cases, restrictions = restrictions, country_iso = country_iso)
}
...
#run_main("/Users/flashton/Dropbox/COVID/AAP_introductions/results/2022.12.02/malawian_introductions.excl_mwi_dups.txt", "MWI", n_cases = national_cases, vocs_to_plot = vocs_to_plot, restrictions = restrictions)
#run_main("/Users/flashton/Dropbox/COVID/AAP_introductions/results/2022.12.02/kenyan_introductions.txt", "KEN", n_cases = national_cases, vocs_to_plot = vocs_to_plot, restrictions = restrictions)
...
3. update the VOCs of interest to be relevant to each country
4. the per sample intros has NAs for some of the dates
